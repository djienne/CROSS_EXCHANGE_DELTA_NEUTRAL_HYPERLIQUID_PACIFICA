...
def setup_logger(name, log_file, level=logging.INFO):
    ...
    # File Handler
    # APPEND + rotate, never mode='w' - see the note in hyperliquid_pacifica_hedge.py.
    # This connector log is the only record of what the venue actually returned before a
    # crash, so truncating it on restart destroys the evidence.
